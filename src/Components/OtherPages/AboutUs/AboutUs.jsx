        ...
        <div className={styles.AboutUs_Container}>
            <section className={styles.main_qnada_sec}>
                ...
                <section className={styles.AboutUs_info_sec}>
                    ...
                    <p>تیم دانشجویی لحظه کارت همگام با دنیای نوین تکنولوژیگیفت کارت های منحصر به فرید تولید کرده که علاوه بر خلق لحظات شیرین برای عزیزانتان میتوانید صدا و متنی دلخواه خودتان را به آنها هدیه دهید.</p>
