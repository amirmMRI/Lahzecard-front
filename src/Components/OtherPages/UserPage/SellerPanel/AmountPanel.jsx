...
const AmountPanel = () => {
    ...
    const getCardInfo = (event) => {
        ...
        axios
            .get(
                `https://api.lahzecard.com/api/user/readCard${amountData.cardNumber}`,
                axiosConficPostForGet
            )
            .then((response) => {
                if (response) {
                    setload(false);
    ...
    const withdrawlHandler = (event) => {
        ...
        axios
            .post(
                `https://api.lahzecard.com/api/spentlist/createSpentList/${amountData.cardNumber}`,
                WITHDRAWL_DATA,
                axiosConficPost
            )
            .then((response) => {
        ...
        <div className={styles.UserPage_Container}>
            ...
            <section className={styles.left_sec}>
                ...
                <section className={styles.threebtninf}>
                    ...
                    {voiceError ? <p>{voiceError}</p> : undefined}
                    {cardData ? (
                        <section className={styles.remaining_sec}>
                            ...
                            <section
                                className={styles.remaning_sec_forwithdrawal}
                            >
                                <p>مقدار برداشتی</p>
                                <input
                                    className={styles.formInput}
