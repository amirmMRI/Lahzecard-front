            ...
            { notif ?
                <section className={styles.RulesNotif_sec}>
                    <div className={styles.rules_div}>
                        ...
                        <p>متن یا صدای شما بایستی منطبق با قوانین و مقررات جاری کشور باشد در غیر این صورت استارتاپ لحظه کارت مطابق با الزامات و قوانین حاکم، اختیار تام در خصوص رد صدا یا متن ثبت شده داشته.</p>
