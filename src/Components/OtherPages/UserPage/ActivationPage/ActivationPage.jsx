            ...
            {notif ? (
                <section className={styles.RulesNotif_sec}>
                    <div className={styles.rules_div}>
                        ...
                        <p>
                        متن و یا صدای شما بایستی منطبق با قوانین و مقررات جاری کشور باشد در غیر این صورت استارتاپ لحظه کارت مطابق با الزامات و قوانین حاکم،
                        اختیار تام در خصوص رد صدا و یا متن ثبت شده داشته.
                        </p>
                        <p>
                        ...
                        <p>
                        امکان استفاده از اسماء جالله، آیات متبرک قرآن، ادعیه، اسامی و القاب امامان و معصومین وجود ندارد.
                       </p>
                       <p>
                       از آپلود صدای خوانندگان یا آهنگ خودداری نمایید.
                       </p>
                        <p>
                        پس از ثبت صدا و متن شما، امکان ویرایش و پاک کردن از جانب شما وجود ندارد و در صورتی که پس از یک روز صدا و و متن شما در qrcode قرار
                        نگرفت به معنی این است صدا و یا متن شما مورد پذیرش نبوده و لطفا با درنظر گرفتن قوانین مجددا صدا و متن خود را بارگذاری کنید.
                        </p>
